...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in select(., Date, CANtoGBP, EURtoGBP, USDtoGBP): unused arguments (Date, CANtoGBP, EURtoGBP, USDtoGBP)}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in select(., Date, CANtoGBP\_MA49, EURtoGBP\_MA49, USDtoGBP\_MA49): unused arguments (Date, CANtoGBP\_MA49, EURtoGBP\_MA49, USDtoGBP\_MA49)}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.factor(x): object 'plot\_data' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(plot\_dt, aes(x = Date, y = Rate, color = Currency)): object 'plot\_dt' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(plot\_data, aes(x = Date, y = Rate, color = Currency)): object 'plot\_data' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as\_gtable(plot): object 'p2' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cowplot::plot\_grid(p1, p2, rel\_widths = c(1, 1), nrow = 2): object 'p1' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cowplot::plot\_grid(combined\_plot, p2\_legend, nrow = 1, rel\_widths = c(2, : object 'combined\_plot' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in select(., where(is.numeric), -year, species): unused arguments (where(is.numeric), -year, species)}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in select(., -species): unused argument (-species)}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.data.frame(.): object 'tSNE\_fit' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fortify(data): object 'tSNE.plot' not found}}\end{kframe}
\end{knitrout}
