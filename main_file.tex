...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-PCAbiplot-comparison-1} 

}

\caption[PCA biplots of mtcars dataset]{PCA biplots of mtcars dataset}\label{fig:PCAbiplot-comparison}
\end{figure}
