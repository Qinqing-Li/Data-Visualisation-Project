...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#MATHEMATICAL CONSTRUCTION OF A BIPLOT USING THE MTCARS DATASET}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in L \%\textasciicircum{}\% (alpha): could not find function "{}\%\textasciicircum{}\%"{}}}\begin{alltt}
\hlstd{H} \hlkwb{<-} \hlkwd{t}\hlstd{((L}\hlopt{%^%} \hlstd{(}\hlnum{1}\hlopt{-}\hlstd{alpha))} \hlopt{%*%} \hlkwd{t}\hlstd{(A))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in L \%\textasciicircum{}\% (1 - alpha): could not find function "{}\%\textasciicircum{}\%"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'H' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'G2' not found}}\begin{alltt}
\hlkwd{par}\hlstd{(}\hlkwc{new} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in par(new = TRUE): calling par(new=TRUE) with no plot}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'H2' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(3): plot.new has not been called yet}}\begin{alltt}
...
\caption[PCA Biplot of mtcars Dataset]{PCA Biplot of mtcars Dataset: R In-built Function}\label{fig:PCAbiplot}
\end{figure}
