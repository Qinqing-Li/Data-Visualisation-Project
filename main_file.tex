...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(4L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x40f>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10004 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(5L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x411>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10004 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(6L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x413>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10000 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(7L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x415>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10000 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(8L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x417>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10000 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(9L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x419>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10005 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(10L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10004 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(11L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10004 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(12L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10004 ms}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(13L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Connection timeout after 10000 ms}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(data\_list, filter\_fire): object 'data\_list' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., acq\_date = as.Date(acq\_date, format = "{}\%Y-\%m-\%d"{})): object 'confident\_fire\_fy22' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in format(confident\_fire\_months\_fy22\$month, "{}\%b"{}): object 'confident\_fire\_months\_fy22' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in factor(confident\_fire\_months\_fy22\$abb\_month, levels = custom\_order): object 'confident\_fire\_months\_fy22' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(confident\_fire\_months\_fy22, aes(x = abb\_month, y = as.character(2022), : object 'confident\_fire\_months\_fy22' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrangeGrob(...): object 'space\_heatmap' not found}}\begin{alltt}
\hlkwd{print}\hlstd{(spacetime_fy22)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(spacetime\_fy22): object 'spacetime\_fy22' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in list2(...): object 'confident\_fire\_decade' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., acq\_date = as.Date(acq\_date, format = "{}\%Y-\%m-\%d"{}), : object 'combined\_confident\_fire' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., abb\_month = gsub("{}.*?([A-Za-z]\{3\}).*"{}, "{}\textbackslash{}\textbackslash{}1"{}, month\_year)): object 'pivot\_table' not found}}\end{kframe}
\end{knitrout}
