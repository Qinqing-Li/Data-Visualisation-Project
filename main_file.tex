...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in scatterplot3d(trees\$Girth, trees\$Height, trees\$Volume, color = color\_assign, : could not find function "{}scatterplot3d"{}}}\end{kframe}
\end{knitrout}
