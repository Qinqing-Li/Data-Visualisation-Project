...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-loess-plot-1} 

}

\caption[LOESS regression model is indicated in red, linear regression model is indicated in blue]{LOESS regression model is indicated in red, linear regression model is indicated in blue.}\label{fig:loess-plot}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-biplot-1} 
