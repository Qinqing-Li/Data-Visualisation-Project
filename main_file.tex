...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in st\_read("{}London\_Ward.shp"{}): could not find function "{}st\_read"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in merge(london\_boroughs, borough\_totals, by.x = "{}DISTRICT"{}, by.y = "{}LookUp\_BoroughName"{}): object 'london\_boroughs' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in group\_by(., DISTRICT): object 'merged\_data' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in st\_centroid(aggregated\_data\$geometry): could not find function "{}st\_centroid"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data = aggregated\_data): object 'aggregated\_data' not found}}\end{kframe}
\end{knitrout}
