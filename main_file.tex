...
\subsection{Introduction to Modern Data Visualisation Methods}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(4L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003bc>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10014 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(5L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003be>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10006 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(6L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003c0>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10011 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(7L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003c2>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10001 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(8L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003c4>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10004 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(9L, class = c("{}curl"{}, "{}connection"{}), conn\_id = <pointer: 0x00000000000003c6>), : Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10005 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(10L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10011 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(11L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10008 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(12L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10006 ms: Timeout was reached}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(structure(13L, class = c("{}curl"{}, "{}connection"{}: Timeout was reached: [firms.modaps.eosdis.nasa.gov] Failed to connect to firms.modaps.eosdis.nasa.gov port 443 after 10004 ms: Timeout was reached}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'brazil\_fire\_fy13' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'data\_list' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_decade' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_fy22' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_months\_fy22' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_months\_fy22' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_months\_fy22' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'spacetime\_fy22' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'confident\_fire\_decade' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'combined\_confident\_fire' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'pivot\_table' not found}}\end{kframe}
\end{knitrout}
...
\hlkwd{ggplot}\hlstd{(df,} \hlkwd{aes}\hlstd{(Date))}\hlopt{+}
  \hlkwd{geom_line}\hlstd{(}\hlkwd{aes}\hlstd{(}\hlkwc{y} \hlstd{= EURtoGBP,} \hlkwc{color} \hlstd{=} \hlstr{"EURtoGBP"}\hlstd{))}\hlopt{+}
  ...
  \hlkwd{labs}\hlstd{(}\hlkwc{color} \hlstd{=} \hlstr{"Currency"}\hlstd{)} \hlopt{+}
  \hlkwd{theme_minimal}\hlstd{()}
\end{alltt}
\end{kframe}
...
\text{https://data.london.gov.uk/dataset/land-area-and-population-density-ward-and-borough}

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## Reading layer `London_Ward' from data source 
##   `C:\Users\pfull\Documents\Data-Visualisation-Project\London_Ward.shp' 
