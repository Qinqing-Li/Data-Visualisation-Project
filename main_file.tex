...
\noindent
In this chapter, we will introduce some state-of-the-art graphical statistical methods published in recent research. In Chapter 6.1, we will introduce the foundational visualisation methods box plots and Q-Q plots. Then, we will discuss the theory and implementation of functional box plots and Q-Q Box Plots, as published in the \textit{Journal of Computational and Graphical Statistics}.\\
