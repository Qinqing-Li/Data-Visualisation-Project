...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-box-plot-1} 

}

\caption[Box Plot of Sepal Length by Species]{Box Plot of Sepal Length by Species}\label{fig:box-plot}
\end{figure}
