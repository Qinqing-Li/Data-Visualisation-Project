...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#PRINCIPAL CURVE FUCNTION}

\hlcom{# Dataset x with two dimensions}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t\textasciicircum{}3: non-numeric argument to binary operator}}\begin{alltt}
