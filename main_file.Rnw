...
<<PCAbiplot-deconstruction, fig.height=5, fig.width=8, fig.cap='PCA biplot of mtcars dataset: mathematical construction', message=FALSE>>=
...
# Create a biplot-like plot
par(mfrow = c(1, 2), pty = "s")
plot(G2, xlim = c(-0.25, 0.4), xlab = "PC1", ylab = "PC2")
par(new = TRUE)
...
<<PCAbiplot, fig.height=5, fig.width=8, fig.cap='PCA biplot of mtcars dataset: R built-in function', message=FALSE>>=
...
\subsection{Functional Box Plot}
