...
<<data-plots, echo=FALSE, message=FALSE, fig.height=7, fig.width=10, fig.cap='Different types of visualisation according to the data type used'>>=
...
\noident Additionally, providing a clear and concise legend becomes imperative to explain the meaning of colours, especially when dealing with complex or unfamiliar colour schemes. A comprehensive legend helps viewers decipher the represented data accurately.\\
...
<<bubble-plot, echo=FALSE, fig.height=4, fig.width=8, fFig.caption='Bubble plot illustrating the relationship between car models and miles per gallon'>>=
#Create bubble plot 
