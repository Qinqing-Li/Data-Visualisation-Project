...
%\noindent Reference: https://www.youtube.com/watch?v=vbGw7BTWYS4

\noident \textbf{PCA and biplots}\\

\noindent Having this decomposition of the data , it can be further rewritten as
