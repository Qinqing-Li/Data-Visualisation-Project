...
#v is the vector that contains the values used in the histogram
...
#break is used to mention the width of each bar.
@
...
<<hist3, echo=TRUE,fig.height=4, fig.width=6, fig.cap='Histogram of Sepal Length in Iris Dataset'>>=
