...
\noindent
The \textit{qqboxplot} package helps us to build Q—Q boxplot which combines both Q—Q plot and boxplot, offering a more comprehensive visual assessment tool. It  enhances traditional boxplot and Q—Q plot by integrating their advantages together.
