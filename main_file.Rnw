...
<<data-plots, echo=FALSE, message = FALSE, , fig.height=3, fig.width=4, fig.cap='Different types of visualisation according to the data type used'>>=
...
<<cogload-plot, echo=FALSE, fig.height=3, fig.width=6, fig.cap='High vs low cognitive load demand through the reduction of visual complexity'>>=
