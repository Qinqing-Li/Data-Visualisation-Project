...
<<decomposition of time series, message=FALSE,warning=FALSE, fig.pos = 'H',fig.dim = c(5, 4), fig.cap='Decomposition of addictive time series model of CNY to GBP exchange rates'>>=
