...
\noindent Generally, the formula for calculating the bubble size (\(S\)) often involves applying the scaling function
\[
S = k \cdot V,
\]
...
<<bubble-plot, echo=FALSE, fig.height=4, fig.width=10, fig.cap='Bubble plot illustrating trends in car types and performance', message=FALSE>>=
...
<<bubble-plot-construction, echo=FALSE, fig.height=3, fig.width=11, fig.cap='Scatter plots deconstruction of Figure 16', message=FALSE>>=
...
<<biplot, echo=FALSE, fig.height=3, fig.width=4, fig.cap='PCA Biplot of mtcars Dataset: Principal Component Analysis', message=FALSE>>=
data(mtcars)
