...
<<bubble-plot, echo=FALSE, fig.height=4, fig.width=8, Fig.caption='Bubble plot illustrating the relationship between car models and miles per gallon'>>=
#Create bubble plot 
