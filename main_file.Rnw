...
where \( x_k \) denotes the exchange rate on day $k$.\\F
...
<<PCAbiplot, fig.height=5.5, fig.width=11.5, fig.cap='PCA biplots of mtcars dataset', message=FALSE>>=
...
plot(x, xlab = "Dimension 1", ylab = "Dimension 2", col = "#459395")

# Fit principal curve to the dataset
fit <- principal_curve(x)

# Plot the principal curve along with the data points
plot(fit, xlab = "Dimension 1", ylab = "Dimension 2")
