...
<<barcharts, echo=FALSE, warning=FALSE, fig.height=3, fig.width=10, fig.cap='Visualising tooth growth by gosage: A comparison of grouped and stacked bar chart techniques' >>=
# average length
