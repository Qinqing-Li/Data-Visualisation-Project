...
\subsubsection{Case Example: Fire in Brazil}
\noindent
...
\\
\noindent
where $\mathbf{1}_n$ is an n-vector of 1.
\\  
...
\subsubsection{Case Example: Image of handwritten digits}
...
<<PCAbiplot-deconstruction, fig.height=4, fig.width=7, fig.cap='PCA Biplot of mtcars Dataset: Mathematical Construction', message=FALSE>>=
#MATHEMATICAL CONSTRUCTION OF A BIPLOT USING THE MTCARS DATASET
...
<<PCAbiplot, fig.height=4, fig.width=7, fig.cap='PCA Biplot of mtcars Dataset: R In-built Function', message=FALSE>>=
